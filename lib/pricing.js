...
export const MIXING_FEE = 15.00
export const VIAL_COST = 5.00

export const DELIVERY_FEES = {
  local: 3.00,         // same state as the studio
  national: 8.00,       // other Nigerian states
  international: 25.00, // outside Nigeria
}
